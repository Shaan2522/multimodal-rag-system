...
# === Folder with input JSONs ===
input_folder = "assets/extractedText/ESM_Elbit" # your path
folder_name = os.path.splitext(os.path.basename(input_folder))[0]
output_folder = f"assets/embeddedJSONs/{folder_name}"
...
print(f"\n[✓✓] All JSON files processed. Saved to: {output_folder}")
